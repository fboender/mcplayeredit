...
itemsdb_data = [
	...
	[110,  0, 'Mycelium',                64, True],
	[111,  0, 'Lily Pad',                64, True],
	[112,  0, 'Nether Brick',            64, True],
	[113,  0, 'Nether Brick Fence',      64, True],
	[114,  0, 'Nether Brick Stairs',     64, True],
	[115,  0, 'Nether Wart [block]',     64, False],
	[116,  0, 'Enchantment Table',       64, True],
	[117,  0, 'Brewing Stand [block]',   1, False],
	[118,  0, 'Cauldron [block]',        1, False],
	[119,  0, 'End Portal',              1, False],
	[120,  0, 'End Portal Frame',        1, False],
	[121,  0, 'End Stone',               64, True],
	[122,  0, 'Dragon Egg',              64, True],
	...
	[369,  0, 'Blaze Rod',               64, True],
	[370,  0, 'Ghast Tear',              64, True],
	[371,  0, 'Gold Nugget',             64, True],
	[372,  0, 'Nether Wart',             64, True],
#	[373,  0, 'Potion',                  64, True],
	[374,  0, 'Glass Bottle',            64, True],
	[375,  0, 'Spider Eye',              64, True],
	[376,  0, 'Fermented Spider Eye',    64, True],
	[377,  0, 'Blaze Powder',            64, True],
	[378,  0, 'Magma Cream',             64, True],
	[379,  0, 'Brewing Stand',           64, True],
	[380,  0, 'Cauldron',                64, True],
	[381,  0, 'Eye of Ender',            64, True],
	[382,  0, 'Glistering Melon',        64, True],
#	[383,  0, 'Spawner Egg',             64, False],
	[2256, 0, 'Music Disc 1',            1, True],
	[2257, 0, 'Music Disc 2',            1, True],
	[2258, 0, 'Music Disc 3',            1, True],
	[2259, 0, 'Music Disc 4',            1, True],
	[2260, 0, 'Music Disc 5',            1, True],
	[2261, 0, 'Music Disc 6',            1, True],
	[2262, 0, 'Music Disc 7',            1, True],
	[2263, 0, 'Music Disc 8',            1, True],
	[2264, 0, 'Music Disc 9',            1, True],
	[2265, 0, 'Music Disc 10',           1, True],
	[2266, 0, 'Music Disc 11',           1, True],
]
